...
const navItems = computed(() =>
  [
    ...
    {
      path: '/alterations',
      label: t('nav.alterations'),
      icon: HandCoins,
      permission: 'alterations.read',
    },
    {
      path: '/extras',
      label: t('nav.extras'),
      icon: GitBranchPlus,
      permission: 'extras.read',
    },
    {
      path: '/models',
      label: t('nav.models'),
    ...
    {
      path: '/login-requests',
      label: t('nav.loginRequests'),
      icon: KeyRound,
      permission: 'login_requests.read',
    },
    {
      path: '/payout-requests',
      label: t('nav.payoutRequests'),
      icon: HandCoins,
